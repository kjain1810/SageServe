...
class Executor():
    ...
    def __init__(self,
        ...
        # to cancel any events TODO: We are not cancelling anything, but feel free to add back if someone does
    ...
    def finish_request(self):
        ...
        """
        f = lambda self=self: self.scheduler.request_completion(self.request)
        schedule_event(self.overheads.finish_request, f)
        self.request = None
