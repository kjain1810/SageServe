...
class RequestMetrics():
    request_id: str = ''
    global_router_arrival_timestamp: float = 0.
    global_router_queue_time: float = 0.
    region_router_arrival_timestamp: float = 0.
    region_router_queue_time: float = 0.
    model_endpoint_router_arrival_timestamp: float = 0.
    model_endpoint_router_queue_time: float = 0.
    application_scheduler_arrival_timestamp: float = 0.
    application_scheduler_queue_time: float = 0.
    service_time: float = 0.
    executor_start_timestamp: float = 0.
    application_scheduler_completion_timestamp: float = 0.
    application_scheduler_response_time: float = 0.
    model_endpoint_router_completion_timestamp: float = 0.
    model_endpoint_router_response_time: float = 0.
    region_router_completion_timestamp: float = 0.
    region_router_response_time: float = 0.
    global_router_completion_timestamp: float = 0.
    global_router_response_time: float = 0.
    queue_time: float = 0.
