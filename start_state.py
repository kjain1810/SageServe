...
def load_start_state(start_state_cfg, count, **kwargs):
    """
...
def uniform(start_state_cfg, cluster, application, **kwargs):
    """
    ...
    processors = cluster.get_processors(affinity=application.processor_affinity,
                                        count=application.processor_count)
    allocator.start_spin_up_instance(instance_cfg=instance_cfg,
                                        processors=processors,
                                        parallelism=parallelism,
                                        pre_start=True)

# TODO: refactor this to use the new application and cluster objects
